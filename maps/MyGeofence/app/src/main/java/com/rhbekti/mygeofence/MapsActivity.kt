package com.rhbekti.mygeofence
...
import com.rhbekti.mygeofence.databinding.ActivityMapsBinding
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private val centerLat = -7.792729152961488
    private val centerLng = 110.40837454412707
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        mMap.addMarker(MarkerOptions().position(stanford).title("Universitas Teknologi Digital Indonesia"))
